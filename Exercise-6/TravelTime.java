...
public class TravelTime {
    ...
    public static void main(String[] args) {
        ...
        LocalDate departureDate = LocalDate.of(Integer.parseInt(date[2]), Integer.parseInt(date[1]),Integer.parseInt(date[0]));

        // Parsing the time entered by the user and converting it into a LocalTime object.
        System.out.println("Enter the starting time (HH:MM): ");
        LocalTime departureTime = LocalTime.parse(scanner.next());

        scanner.close();

        System.out.println("The lorry starts at " + departureDate.getDayOfMonth() + "/" + departureDate.getMonthValue()+ "/" + departureDate.getYear() 
        ...
        // This is a while loop that will run until the daysToBeTravelled is greater than 0. meanwhile skipping the leave days.
        ...
        // If the date of arrival is going to be a leave day, then skip the days accordingly
